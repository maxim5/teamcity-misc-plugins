...
public class AntiXssUtilTest extends BaseTestCase {
  ...
  public void test_find_onload_injection() throws Exception {
    ...
    assertTrue(AntiXssUtil.hasPotentialJsInjection("foo <bar onload = '' /> baz"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("foo <bar onload = \"\" /> baz"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("foo <bar onload=alert(1) /> baz"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("foo <bar ONLOAD='' /> baz"));
  }
  ...
  public void test_find_src_injection() throws Exception {
    ...
    assertTrue(AntiXssUtil.hasPotentialJsInjection("<img src = javascript:alert(1)/>"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("<img src = 'javascript:alert(1)'/>"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("<img src = \"javascript:alert(1)\"/>"));
  }
  ...
  public void test_find_js_injection() throws Exception {
    ...
    assertTrue(AntiXssUtil.hasPotentialJsInjection("foo bar');"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("(');"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("(', 'foo');"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("\\'(');"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("(\\'');"));
    assertTrue(AntiXssUtil.hasPotentialJsInjection("(', '', '', '', '', '');"));
  ...
  public void test_no_js_injection() throws Exception {
    ...
    assertFalse(AntiXssUtil.hasPotentialJsInjection("onload"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("ONLOAD"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("foo onload bar"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("foo bar onload='' baz"));

    assertFalse(AntiXssUtil.hasPotentialJsInjection("img src"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("img src="));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("script"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("javascript"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("fooScriptBar"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("javascript:"));

    assertFalse(AntiXssUtil.hasPotentialJsInjection("Don't be evil"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("(foo)"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("foo (bar) baz"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("foo ('bar') baz"));
    assertFalse(AntiXssUtil.hasPotentialJsInjection("foo (\"bar\") baz"));
  }
}
